export function showNotification(message: string, type = 'success'): void {
    ...
    `;
    const colors: { [key: string]: string } = { success: '#28a745', error: '#dc3545', warning: '#ffc107', info: '#17a2b8' };
