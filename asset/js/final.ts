...
class MusicGameClient {
    ...
    private displayMaskedLyrics(lyrics: string, points: number): void {
        ...
        switch(points) {
            case 20000: maskPercentage = 0.8; break;  // 80% masqué pour 50 points
            case 10000: maskPercentage = 0.6; break;  // 60% masqué pour 40 points
            case 5000: maskPercentage = 0.4; break;  // 40% masqué pour 30 points
            case 2000: maskPercentage = 0.2; break;  // 20% masqué pour 20 points
            case 1000: maskPercentage = 0.1; break;  // 10% masqué pour 10 points
        }
